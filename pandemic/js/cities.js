const CITIES = [
  ...
  { id: 'chicago',      name: 'Chicago',      color: 'blue',   x: 158, y: 188, connections: ['atlanta', 'new_york', 'london', 'tokyo'] },
  ...
  { id: 'lima',         name: 'Lima',         color: 'yellow', x: 168, y: 340, connections: ['bogota', 'sao_paulo', 'sydney'] },
  ...
  { id: 'tokyo',        name: 'Tokyo',        color: 'red',    x: 802, y: 188, connections: ['beijing', 'hong_kong', 'sydney', 'chicago'] },
  ...
  { id: 'sydney',       name: 'Sydney',       color: 'red',    x: 818, y: 380, connections: ['jakarta', 'tokyo', 'lima'] },
